...
if (_rndnum == 0) then {
	_grp1 = [getMarkerPos "village1_spawn3a", east, ["CUP_O_Partisans_Engineer", "CUP_O_Partisans_Engineer"],[],[],[],[],[],180] call BIS_fnc_spawnGroup;
	...
	_grp1 = [getMarkerPos "village1_spawn3b", east, ["CUP_O_Partisans_Engineer", "CUP_O_Partisans_Engineer"],[],[],[],[],[],180] call BIS_fnc_spawnGroup;
