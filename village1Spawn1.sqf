...
// 		_grp1 = [getMarkerPos "village1_spawn1b", east, ["CUP_Ins_ER_Guerilla_AR", "OPTRE_Ins_ER_Farmer"],[],[],[],[],[],180] call BIS_fnc_spawnGroup;
// 		_wp1 = _grp1 addWaypoint [getMarkerPos "vil1_grp1_wp2", 0];
// 		_wp1 setWaypointType "SAD"; 
// 		_wp1 setWaypointSpeed "FULL";
// 		_wp1 setWaypointBehaviour "STEALTH";
